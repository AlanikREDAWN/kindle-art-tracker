async function displayDetails() {
    ...
    var selectedCardString = getCookie("selectedCard");
	// if (selectedCard) {
	if (selectedCardString) {
		...
		editWrapper.innerHTML = "<h1>Data must be lost...</h1>";
	}
}
            ...
            if (result.success == true) {
                ...
                form.addEventListener("submit", function (event) {
                    ...
                    if (selectedCard.artwork_name != artworkNameValue) {
                        ...
                        editName(password, selectedCard, artworkNameValue);
                    ...
                    if (selectedCard.who_is_it_for != whoIsItForValue) {
                        ...
                        editFor(password, selectedCard, whoIsItForValue);
                    ...
                    if (selectedCard.status != statusValue) {
                        ...
                        editStatus(password, selectedCard, statusValue);
                    ...
                    if (selectedCard.deadline != deadlineValue) {
                        ...
                        editDeadline(password, selectedCard, deadlineValue);
...
function editFor(password, selectedCard, whoIsItForValue) {
...
function editStatus(password, selectedCard, statusValue) {
...
function editDeadline(password, selectedCard, deadlineValue) {
